...
class EditNote extends StatefulWidget {
  ...
  final String status;
  final String docId;
  const EditNote ({Key? key, required this.docId,required this.title, required this.desc, required this.status})
      : super(key: key);
      ...
      child: Container(
        ...
        child: RaisedButton(
          onPressed: () {
            ...
            if (text == "Update") {
              if (_key.currentState!.validate()) {
                _methods.updateItem(title: _title.text, description: _description.text, docId: widget.docId.toString()).then((value) => Navigator.pop(context));
                ...
                //   _docId = element.reference.id.toString();
                // });
                // print(_docId);
                ...
                //_methods.updateItem(title: title, description: desc, docId: docId);
            ...
            {
              if (_key.currentState!.validate()) {
                _methods.saveData(_title.text, _description.text).then((value) => Navigator.pop(context));
                print('hello');
              }
            }
